...
class ComposerEditButtonPackage extends Package {
	...
	public function on_start() {
	  if(version_compare(APP_VERSION,'5.4.1.1', '>')){
	     ...
	     $ihm->addPageHeaderMenuItem('composer', t('Edit In Composer'), 'left', array('class'=>'ccm-menu-icon ccm-icon-edit', 'href' => '/index.php/dashboard/composer/write/-/edit/' .  $id), 'composer_edit_button');         
	 	}   
	}
